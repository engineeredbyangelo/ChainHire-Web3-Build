...
import { ArrowRight, Shield, Zap, Lock, Clock, Users, Scale, Globe, TrendingUp, CheckCircle2 } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    desc: 'Break work into milestones. Funds release only when each phase is approved — or auto-released after 7 days.',
  },
  {
    icon: Clock,
    title: 'Auto-Release Timer',
    desc: 'Built-in 7-day countdown protects freelancers. No response from the client? Funds auto-release.',
  },
  {
    icon: Scale,
    title: 'Fair Arbitration',
    desc: 'Disputes are resolved by neutral arbitrators for a flat 2.5% fee. Evidence-based, transparent outcomes.',
  },
  {
    icon: Shield,
    title: 'On-Chain Reputation',
    desc: 'Every completed escrow builds your verifiable reputation. Bronze → Silver → Gold → Diamond.',
  },
  {
    icon: Globe,
    title: 'Global & Permissionless',
    desc: 'No KYC, no borders, no bank accounts. Just connect your wallet and start working.',
  },
];

const audiences = [
  { icon: Users, label: 'DAO Contributors', desc: 'Get paid reliably for governance and dev work.' },
  { icon: Zap, label: 'Web3 Developers', desc: 'Secure milestone-based contracts for smart contract and dApp builds.' },
  { icon: TrendingUp, label: 'NFT Artists & Creators', desc: 'Protect your creative work with escrowed payments.' },
  { icon: Globe, label: 'Crypto-Native Founders', desc: 'Hire contractors globally with trustless payment guarantees.' },
];
        ...
        <div className="container relative z-[2] text-center py-20">
          ...
          >
            ...
            >
              Trustless Payments
              <br />
              <span className="text-gradient">for Web3 Work</span>
            </motion.h1>
            ...
            >
              Non-custodial USDC escrow with milestone-based releases,
              auto-release timers, and on-chain reputation — purpose-built
              for crypto-native freelancers and clients.
            </motion.p>
            ...
            <motion.div variants={fadeUp} custom={3} className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button
                asChild
                size="lg"
                className="gradient-neon text-primary-foreground font-semibold text-base glow-neon gap-2 px-8"
              >
                <Link to="/dashboard">
                  Launch App
              ...
              <Button
                variant="outline"
                size="lg"
                className="glass border-glass-border/50 text-base gap-2 px-8"
              >
                Read the Docs
              </Button>
            </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              A complete escrow protocol designed for the way web3 teams actually work.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <motion.div
                ...
                className="gradient-border rounded-xl p-6 group hover:glow-neon transition-shadow"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-lg gradient-neon mb-4">
      ...
      <section className="py-24 relative grid-bg">
        ...
        <div className="container relative">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Stop closing deals over Discord DMs. ChainHire gives you the payment rails web3 deserves.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                Why Teams Choose <span className="text-gradient">ChainHire</span>
              </h2>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="gradient-border rounded-2xl p-8 space-y-6"
            >
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Arbitration only</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-foreground">7 days</p>
                  <p className="text-xs text-muted-foreground">Auto-release</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-foreground font-mono">&lt;$0.01</p>
                  <p className="text-xs text-muted-foreground">Gas per tx</p>
                </div>
              </div>
              <div className="h-px bg-border" />
        ...
        <div className="container relative text-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold">
              Ready to Work <span className="text-gradient">Trustlessly</span>?
            </h2>
            <p className="text-muted-foreground text-lg">
              Connect your wallet and create your first escrow in under 2 minutes.
            </p>
            <Button
              asChild
              size="lg"
              className="gradient-neon text-primary-foreground font-semibold text-base glow-neon gap-2 px-10"
            >
              <Link to="/dashboard">
                Launch App
                <ArrowRight className="h-4 w-4" />
